...
public class SysMenu implements Serializable {
	...
	private static final long serialVersionUID = -5797973459953257053L;
	...
	public SysMenu(Integer id, String name, String url, Integer type, Integer sort, String note, Integer parentId,
			String permission, String createdUser, String modifiedUser, Date createdTime, Date modifiedTime) {
		super();
		this.id = id;
		this.name = name;
		this.url = url;
